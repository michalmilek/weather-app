        ...
        {Object.keys(upcomingDays).length !== 0 && (
          <Box
            ...
            {upcomingDays?.data?.list
              ...
              .map((day: any) => (
                <SmallCard weatherIcon={day.weather[0].icon} wind={day.wind.speed} pressure={day.main.pressure} humidity={day.main.humidity} weatherDesc={day.weather[0].description} tempFeelsLike={day.main.feels_like} temp={day.main.temp} />
                <Card>
                  <Typography>
                    {Math.round(
                      currentTemp === "C"
